...
def write_queue(root, selected, interactions, reflectors, args, dry_run):
    ...
    lines = [
        ...
        "",
        "> Generated by `Tools/world_tick.py`. Ephemeral hand-off — "
        "`Tools/world_scribe.py`",
        "> templates the routine movers, then a Claude director (world-director-lite",
        "> for collisions/reflection, world-director for secret-bearing pivots) decides",
        "> what each agent *does* and writes the consequences. Safe to delete after use.",
        "",
