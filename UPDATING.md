...
|---|---|---|
| **Engine** — shipped by the template, never edited by play | **Overwritten** with the latest version | `CLAUDE.md`, `UPDATING.md`, `VERSION`, `CHANGELOG.md`, `LICENSE`, `README.md`, `.gitignore`, `.claude/agents/` (all agents), `Tools/dice.py`, `Tools/world_tick.py`, `Tools/world_scribe.py`, `Tools/story_compile.py`, `Tools/cultural_profile.py`, `Tools/ledger.py`, `Tools/social.py`, `Tools/firewall.py`, `Tools/actor_brief.py`, `Tools/world_health.py`, `Tools/world_dashboard.py`, `Tools/memory_index.py`, `Tools/memory_search.py`, `Tools/resources.py`, `Tools/local_client.py`, `Tools/local_config.py`, `Tools/local-agents/`, `Cast/README.md`, `Cast/CRAFTING-NPCS.md`, `Cast/_template/`, `Story/chapters/_TEMPLATE.md`, `Sourcebooks/README.md`, `Sourcebooks/_digests/.gitkeep`, `Sourcebooks/_digests/_TEMPLATE.md`, `Character/README.md`, `Character/portraits/.gitkeep` |
...
```
git checkout engine/main -- CLAUDE.md UPDATING.md VERSION CHANGELOG.md LICENSE README.md .gitignore .claude/agents Tools/dice.py Tools/world_tick.py Tools/world_scribe.py Tools/world_health.py Tools/story_compile.py Tools/cultural_profile.py Tools/ledger.py Tools/social.py Tools/firewall.py Tools/actor_brief.py Tools/world_dashboard.py Tools/memory_index.py Tools/memory_search.py Tools/resources.py Tools/local_client.py Tools/local_config.py Tools/local-agents Cast/README.md Cast/CRAFTING-NPCS.md Cast/_template Story/chapters/_TEMPLATE.md Sourcebooks/README.md Sourcebooks/_digests/.gitkeep Sourcebooks/_digests/_TEMPLATE.md Character/README.md Character/portraits/.gitkeep
```
